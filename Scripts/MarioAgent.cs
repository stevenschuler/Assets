...
public class MarioAgent : Agent
{
    ...
    public override void OnEpisodeBegin()
    {
        ...
        // Strategy 2: Do not reset mario position. Instead, continue where he left off so hea can hopefully learn more of the level
    ...
    public override void CollectObservations(VectorSensor sensor)
    {
        ...
        //sensor.AddObservation(mario.GetComponent<Transform>().position.x);
